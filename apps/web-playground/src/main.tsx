...
// The hosted playground does not bundle sample decks — the public
// release ships drag-and-drop only. Local development that wants
// pre-loaded fixtures should drop files into `public/samples/` and
// extend this list.
