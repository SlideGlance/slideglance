...
Unit-aware primitives (`Emu`, `Pt`, `HundredthPt`) and conversion helpers
for OOXML coordinate systems.
...
hundredths of a point (used for paragraph spacing in ECMA-376
§20.1.2.1). This crate exposes zero-cost newtypes around `i64` / `f64`
so unit confusion fails at compile time, plus conversion helpers
