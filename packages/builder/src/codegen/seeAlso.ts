...
export const SEE_ALSO: Readonly<Record<string, ReadonlyArray<SeeAlsoEntry>>> = {
  ...
  Ul: [{ label: "XML reference — Lists", href: `${BUILDER_DOCS}/xml-reference.md` }],
  Ol: [{ label: "XML reference — Lists", href: `${BUILDER_DOCS}/xml-reference.md` }],
  Image: [{ label: "XML reference — Image", href: `${BUILDER_DOCS}/xml-reference.md` }],
  Icon: [{ label: "XML reference — Icon", href: `${BUILDER_DOCS}/xml-reference.md` }],
  Svg: [{ label: "XML reference — Svg", href: `${BUILDER_DOCS}/xml-reference.md` }],
  Table: [{ label: "XML reference — Table", href: `${BUILDER_DOCS}/xml-reference.md` }],
  Shape: [{ label: "XML reference — Shape", href: `${BUILDER_DOCS}/xml-reference.md` }],
  Chart: [{ label: "XML reference — Chart", href: `${BUILDER_DOCS}/xml-reference.md` }],
  Line: [{ label: "XML reference — Line", href: `${BUILDER_DOCS}/xml-reference.md` }],
  VStack: [{ label: "Layout & styling", href: `${BUILDER_DOCS}/layout-and-styling.md` }],
  HStack: [{ label: "Layout & styling", href: `${BUILDER_DOCS}/layout-and-styling.md` }],
  Layer: [{ label: "Layout & styling", href: `${BUILDER_DOCS}/layout-and-styling.md` }],

  // Meta / composition / control flow
  Document: [{ label: "Layout & styling", href: `${BUILDER_DOCS}/layout-and-styling.md` }],
  Styles: [{ label: "Layout & styling", href: `${BUILDER_DOCS}/layout-and-styling.md` }],
  Style: [{ label: "Layout & styling", href: `${BUILDER_DOCS}/layout-and-styling.md` }],
