...
> = {
  ...
  Td: {
    ...
    borderTop: { coerce: "border", dotNotation: true },
    borderRight: { coerce: "border", dotNotation: true },
    borderBottom: { coerce: "border", dotNotation: true },
    borderLeft: { coerce: "border", dotNotation: true },
  },
  Li: {
    text: { coerce: "string" },
    bold: { coerce: "boolean" },
