...
The TypeScript-side VRT (deck-level + node-level + preview) lives at
[`packages/builder/vrt/`](../packages/builder/vrt/). Same name, different
language and target — see that subtree's structure for the builder VRT
flavor.
